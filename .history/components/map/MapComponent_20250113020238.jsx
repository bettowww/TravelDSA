  ...
  useEffect(() => {
    ...
    const initializeMap = async () => {
      try {
        ...
        // // Layer GeoJSON cu regiunile României
        // const regionLayer = new GeoJSONLayer({
        //     url: "/romania_regions.geojson",
        //     renderer: {
        //     type: "simple",
        //     symbol: {
        //         type: "simple-fill",
        //         color: [0, 0, 255, 0.1], // Albastru transparent
        //         outline: {
        //         color: [0, 0, 255],
        //         width: 2,
        //         },
        ...
        // Eveniment pentru selectarea layer-ului tematic și afișarea regiunilor
        if (selectedLayer) {
            const thematicLayer = new GeoJSONLayer({
