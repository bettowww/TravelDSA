    ...
    const initializeMap = async () => {
      try {
        ...
        if (selectedLayer?.url) {
            console.log("Încerc să adaug layer-ul tematic:", selectedLayer);
            ...
            thematicLayer.when(() => {
              console.log("Layer tematic încărcat cu succes:", thematicLayer);
            }).catch((error) => {
              console.error("Eroare la încărcarea layer-ului tematic:", error);
            });
